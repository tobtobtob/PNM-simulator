...
import simulator.algorithms.BMM;
import simulator.algorithms.VC3;
...
public class PNMSimulator {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("RUNNING BMM ON A SAMPLE GRAPH:\n");
        //run(nodes);
        System.out.println("");
        
        nodes = createVC3Network(); 
        System.out.println("RUNNING VC3 ON A SAMPLE GRAPH:\n");
        run(nodes);
    }
